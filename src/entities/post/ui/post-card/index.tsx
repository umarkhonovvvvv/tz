...
export const PostCard = ({ post }: { post: any }) => {
  ...
  return (
    <motion.div
      ...
      whileHover={{ y: -8 }}
      className="premium-glass p-8 group cursor-pointer h-full flex flex-col justify-between"
    >
      <div className="relative z-10">
        ...
        <p className="font-light leading-relaxed text-white/60 text-base line-clamp-3 italic">
          "{post.body}"
        </p>
      </div>
